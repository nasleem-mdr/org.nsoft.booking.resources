...
/** Generated Model for NS_Booking
 *  @author iDempiere (generated) 
 *  @version Release 7.1 - $Id$ */
public class X_NS_Booking extends PO implements I_NS_Booking, I_Persistent 
{
    ...
    public X_NS_Booking (Properties ctx, int NS_Booking_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_NS_Booking (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_NS_Booking[")
	...
	/** Set Booking.
		@param NS_Booking_ID Booking	  */
	public void setNS_Booking_ID (int NS_Booking_ID)
	{
		if (NS_Booking_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_NS_Booking_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_NS_Booking_ID, Integer.valueOf(NS_Booking_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_NS_Booking_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set NS_Booking_UU.
		@param NS_Booking_UU NS_Booking_UU	  */
	public void setNS_Booking_UU (String NS_Booking_UU)
	{
		set_Value (COLUMNNAME_NS_Booking_UU, NS_Booking_UU);
	}

	/** Get NS_Booking_UU.
		@return NS_Booking_UU	  */
	public String getNS_Booking_UU () 
	{
		return (String)get_Value(COLUMNNAME_NS_Booking_UU);
	}
