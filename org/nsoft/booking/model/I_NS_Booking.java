...
/** Generated Interface for NS_Booking
 *  @author iDempiere (generated) 
 *  @version Release 13
 */
@SuppressWarnings("all")
public interface I_NS_Booking 
{

    /** TableName=S_Booking */
    public static final String Table_Name = "NS_Booking";
    ...
    /** Column name NS_Booking_ID */
    public static final String COLUMNNAME_NS_Booking_ID = "NS_Booking_ID";

	/** Set Booking	  */
	public void setNS_Booking_ID (int NS_Booking_ID);

	/** Get Booking	  */
	public int getNS_Booking_ID();

    /** Column name NS_Booking_UU */
    public static final String COLUMNNAME_NS_Booking_UU = "NS_Booking_UU";

	/** Set NS_Booking_UU	  */
	public void setNS_Booking_UU (String NS_Booking_UU);

	/** Get NS_Booking_UU	  */
	public String getNS_Booking_UU();
